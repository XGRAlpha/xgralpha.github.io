(function(){
  ...
  function injectTypography(){
    ...
    style.textContent = `
      ...
      .whatsapp-float{position:fixed!important;right:20px!important;bottom:20px!important;width:58px!important;height:58px!important;min-width:58px!important;min-height:58px!important;padding:0!important;border-radius:999px!important;display:flex!important;align-items:center!important;justify-content:center!important;background:#25d366!important;color:#071107!important;box-shadow:0 18px 40px rgba(0,0,0,.28)!important;z-index:90!important;transition:.25s ease!important;line-height:1!important;font-size:0!important;}
      .whatsapp-float:hover{transform:translateY(-3px)!important;}
      .whatsapp-float span{font-family:var(--font-title);font-size:1rem;font-weight:900;letter-spacing:-.04em;line-height:1;color:#071107;}
      ...
      @media (max-width:560px){.hero-copy h1{font-size:clamp(2.45rem,12vw,3.35rem);line-height:1;}.section-head h2,.section-copy h2,.contact-card h2,.final-cta h2{font-size:clamp(1.95rem,9vw,2.6rem);}.whatsapp-float{right:14px!important;bottom:14px!important;width:54px!important;height:54px!important;min-width:54px!important;min-height:54px!important;}.whatsapp-float span{font-size:.95rem;}.back-to-top{bottom:18px;height:42px;padding:0 13px 0 11px;font-size:.72rem;}}
    `;
  ...
  function loadBackground(slot){
    ...
    preloadImage(src)
      .catch(function(){return fallback ? preloadImage(fallback) : Promise.reject();})
  ...
  function showPoster(hero, posterSrc, posterFallback){
    ...
    preloadImage(posterSrc)
      .catch(function(){return posterFallback ? preloadImage(posterFallback) : Promise.reject();})
      .then(function(loadedSrc){
  ...
  function loadHeroVideo(hero){
    ...
    video.addEventListener('error', function(){showPoster(hero, posterSrc, posterFallback);}, { once: true });
    video.load();
  }
