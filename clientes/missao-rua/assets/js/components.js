(function(){
  ...
  style.textContent=`
    ...
    .icon-badge img{display:block;max-width:36px;max-height:36px;object-fit:contain}
    .icon-badge--wide{width:88px}.icon-badge--wide img{max-width:74px;max-height:34px}
    ...
    .whatsapp-float{position:fixed!important;right:22px!important;bottom:22px!important;width:64px!important;height:64px!important;display:flex!important;align-items:center!important;justify-content:center!important;z-index:90!important;background:transparent!important;border:0!important;box-shadow:none!important;padding:0!important;margin:0!important;line-height:0!important;overflow:visible!important}.whatsapp-float::before{content:none!important;display:none!important}.whatsapp-float svg{display:none!important}.whatsapp-float img{width:58px!important;height:58px!important;object-fit:contain!important;display:block!important;filter:drop-shadow(0 12px 22px rgba(37,211,102,.28))}.whatsapp-float:hover{transform:translateY(-2px)}
    @media(max-width:900px){
      html,body{max-width:100%;overflow-x:hidden}
      .topbar{position:relative!important;top:auto!important;padding:14px 0!important}
      .topbar__inner{width:min(100% - 28px,1180px)!important;display:flex!important;flex-direction:column!important;align-items:flex-start!important;gap:14px!important;margin:0 auto!important}
      .brand{width:100%!important;display:flex!important;align-items:center!important;gap:12px!important}
      .brand__text strong{font-size:1rem!important}.brand__text span{font-size:.68rem!important;letter-spacing:.22em!important}
      .topbar__right{width:100%!important;display:flex!important;align-items:center!important;gap:10px!important}
      .nav{width:100%!important;display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:8px!important;overflow:visible!important;white-space:normal!important}
      ...
      .header-social{width:42px!important;height:42px!important;flex:0 0 42px!important;display:grid!important;place-items:center!important}
      ...
      .help-hero-grid{display:grid!important;grid-template-columns:1fr!important;gap:26px!important;align-items:start!important}
      h1{font-size:clamp(2.65rem,14vw,4.7rem)!important;line-height:.98!important;letter-spacing:-.06em!important;max-width:100%!important;overflow-wrap:normal!important;word-break:normal!important}
      ...
      .help-card-img{width:100%!important;max-width:100%!important;border-radius:24px!important;margin:0!important;object-fit:contain!important}
      ...
      .footer{padding:38px 0 18px!important}.footer__inner{grid-template-columns:1fr!important;gap:18px!important;align-items:start!important;width:min(100% - 28px,1180px)!important}.whatsapp-float{right:16px!important;bottom:16px!important}
    }
    @media(max-width:430px){.nav{grid-template-columns:1fr 1fr!important}.nav a{font-size:.86rem!important}.site-icon{width:44px!important;height:44px!important}.hero{padding-top:36px!important}h1{font-size:clamp(2.45rem,16vw,4.2rem)!important}.kicker{font-size:.72rem!important;padding:12px 18px!important}.lead{font-size:1rem!important}}
  `;
